...
import '../../../../OnlineStore/Widget/custom_widgets.dart';
import '../../../../Tenders/Widget/custom_tiles.dart';
import '../Notifier/product_catalouge_detail_sales_notifier.dart';

class ProductCatalougeDetailSalesPage extends ConsumerWidget {
  const ProductCatalougeDetailSalesPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final controller = ref.watch(productCatalougeDetailDetailProvider.notifier);
    final state = ref.watch(productCatalougeDetailDetailProvider);
    return Scaffold(
      appBar: MyAppBar(
        title: "Detail",
        bellOnTap: () {

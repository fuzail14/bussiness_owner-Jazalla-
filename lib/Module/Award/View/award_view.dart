...
import '../Notifier/award_notifier.dart';

// ignore: must_be_immutable
class AwardView extends ConsumerWidget {
  int buildcheck = 0;
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final controller = ref.watch(awardProvider.notifier);
    final state = ref.watch(awardProvider);

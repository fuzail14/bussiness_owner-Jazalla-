...
import '../State/inventory_management_sales_state.dart';

class InventoryManagementSalesNotifier
    extends StateNotifier<InventoryManagementSalesState> {
  final Person? person;
  final invoiceManagmentRepository = InvoiceManagmentRepository();

  InventoryManagementSalesNotifier(this.person)
      : super(InventoryManagementSalesState()) {
    invoiceForBuyerView(
...
final inventoryManagementSalesProvider = StateNotifierProvider.autoDispose<
    InventoryManagementSalesNotifier, InventoryManagementSalesState>((ref) {
  final person = ref.read(personProvider);
  if (person == null) {
    throw Exception('Person data is not available');
  }
  return InventoryManagementSalesNotifier(person);
});

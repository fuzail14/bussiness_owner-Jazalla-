...
import '../Notifier/order_management_detail_sales_notifier.dart';
import 'package:pdf/widgets.dart' as pw;
import 'package:path_provider/path_provider.dart';
import 'package:printing/printing.dart';

class OrderManagementDetailSalesPage extends ConsumerWidget {
  const OrderManagementDetailSalesPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final controller = ref.watch(orderManagementDetailSalesProvider.notifier);
    final state = ref.watch(orderManagementDetailSalesProvider);
    return Scaffold(
      appBar: MyAppBar(

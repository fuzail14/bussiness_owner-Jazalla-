...
import '../Notifier/bid_service_response_recieve_notifier.dart';

// ignore: must_be_immutable
class BidServiceResponseRecieveView extends ConsumerWidget {
  int buildcheck = 0;

  BidServiceResponseRecieveView({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    // print(person!.data!.id!);

    final controller = ref.watch(bidServiceResponseRecieveProvider.notifier);
    final state = ref.watch(bidServiceResponseRecieveProvider);

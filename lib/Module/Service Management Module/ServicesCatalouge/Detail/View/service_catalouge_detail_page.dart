...
import '../Notifier/service_catalouge_detail_notifier.dart';

class ServiceCatalougeDetailPage extends ConsumerWidget {
  const ServiceCatalougeDetailPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final controller = ref.watch(serviceCatalougeDetailProvider.notifier);
    final state = ref.watch(serviceCatalougeDetailProvider);
    return Scaffold(
      appBar: MyAppBar(
        title: "Detail",
        bellOnTap: () {

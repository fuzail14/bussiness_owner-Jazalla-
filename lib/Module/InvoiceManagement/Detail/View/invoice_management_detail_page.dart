...
class InvoiceManagementDetailPage extends ConsumerWidget {
  const InvoiceManagementDetailPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final controller = ref.watch(invoiceManagementDetailProvider.notifier);
    final state = ref.watch(invoiceManagementDetailProvider);
    return Scaffold(
      appBar: MyAppBar(

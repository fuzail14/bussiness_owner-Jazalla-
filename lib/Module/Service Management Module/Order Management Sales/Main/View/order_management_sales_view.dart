...
import '../Notifier/order_management_sales_notifier.dart';

// ignore: must_be_immutable
class OrderManagementSalesView extends ConsumerWidget {
  int buildcheck = 0;

  OrderManagementSalesView({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    // print(person!.data!.id!);

    final controller = ref.watch(orderManagementSalesProvider.notifier);
    final state = ref.watch(orderManagementSalesProvider);
      ...
      body: Column(
        children: [
          Padding(
            ...
            child: Text('Order Management List',
                style: FontManagment()
                      ...
                      return GestureDetector(
                        onTap: () {
                          GoRouter.of(context).pushNamed(
                            orderManagementDetailSalesPage,
                            pathParameters: {
                                      ...
                                      onTap: () {
                                        showDialog(
                                            ...
                                            builder: (BuildContext context) =>
                                                DraftSentDialog(
                                                    title:
                                                        'Do you want to published your order?'));
                                      },
                                      child: Container(
                                        height: 24,
                                        width: 96,

...
const String userTypeProcurementManager = 'procurement manager';
const String userTypeServiceManager = 'service manager';
const String userTypeSalesManager = 'sales manager';
const String userTypeAccountingManager = 'accounting manager';

...
class SupplierRecievedInvitationScreen extends ConsumerWidget {
  int buildcheck = 0;

  SupplierRecievedInvitationScreen({super.key});
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final controller = ref.watch(supplierRecievedInvitationProvider.notifier);
    final state = ref.watch(supplierRecievedInvitationProvider);

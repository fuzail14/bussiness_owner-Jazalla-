...
import '../State/order_management_procurement_state.dart';

class OrderManagementProcurementNotifier
    extends StateNotifier<OrderManagementProcurementState> {
  final Person? person;
  final invoiceManagmentRepository = InvoiceManagmentRepository();

  OrderManagementProcurementNotifier(this.person)
      : super(OrderManagementProcurementState()) {
    invoiceForBuyerView(
...
final orderManagementProvider = StateNotifierProvider.autoDispose<
    OrderManagementProcurementNotifier, OrderManagementProcurementState>((ref) {
  final person = ref.read(personProvider);
  if (person == null) {
    throw Exception('Person data is not available');
  }
  return OrderManagementProcurementNotifier(person);
});

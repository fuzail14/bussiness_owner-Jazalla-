...
import '../Notifier/bid_procurement_response_recieve_notifier.dart';

// ignore: must_be_immutable
class BidProcurementResponseRecieveView extends ConsumerWidget {
  int buildcheck = 0;

  BidProcurementResponseRecieveView({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final controller =
        ref.watch(bidProcurementResponseRecieveProvider.notifier);
    final state = ref.watch(bidProcurementResponseRecieveProvider);

...
import '../State/bid_management_sales_state.dart';

class BidManagementSalesNotifier
    extends StateNotifier<BidManagementSalesState> {
  final Person? person;
  final invoiceManagmentRepository = InvoiceManagmentRepository();

  BidManagementSalesNotifier(this.person) : super(BidManagementSalesState()) {
    invoiceForBuyerView(
...
final bidManagementSalesProvider = StateNotifierProvider.autoDispose<
    BidManagementSalesNotifier, BidManagementSalesState>((ref) {
  final person = ref.read(personProvider);
  if (person == null) {
    throw Exception('Person data is not available');
  }
  return BidManagementSalesNotifier(person);
});

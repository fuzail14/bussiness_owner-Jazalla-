...
import '../Notifier/order_management_detail_notifier.dart';
import 'package:pdf/widgets.dart' as pw;
import 'package:path_provider/path_provider.dart';
import 'package:printing/printing.dart';

class OrderManagementDetailPage extends ConsumerWidget {
  const OrderManagementDetailPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final controller = ref.watch(orderManagementDetailProvider.notifier);
    final state = ref.watch(orderManagementDetailProvider);
    return Scaffold(
      appBar: MyAppBar(

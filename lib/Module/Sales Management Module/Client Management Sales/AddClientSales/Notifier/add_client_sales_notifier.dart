...
import '../State/add_client_sales_state.dart';

class AddClientSalesNotifier extends StateNotifier<AddClientSalesState> {
  final request4InformationRepository = Request4InformationRepository();
  final Person person;
  AddClientSalesNotifier({required this.person})
      : super(AddClientSalesState()) {
...
final addClientSalesProvider = StateNotifierProvider.autoDispose<
    AddClientSalesNotifier, AddClientSalesState>((ref) {
  final person = ref.read(personProvider);
  if (person == null) {
    throw Exception('Person data is not available');
  }
  return AddClientSalesNotifier(person: person);

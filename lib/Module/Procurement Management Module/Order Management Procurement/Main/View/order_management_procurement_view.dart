...
import '../Notifier/order_management_procurement_notifier.dart';

// ignore: must_be_immutable
class OrderManagementProcurementView extends ConsumerWidget {
  int buildcheck = 0;

  OrderManagementProcurementView({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    // print(person!.data!.id!);

    final controller = ref.watch(orderManagementProvider.notifier);

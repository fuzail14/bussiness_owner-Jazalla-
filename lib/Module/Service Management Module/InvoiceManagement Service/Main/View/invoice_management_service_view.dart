...
import '../Notifier/invoice_management_service_notifier.dart';

// ignore: must_be_immutable
class InvoiceManagementServiceView extends ConsumerWidget {
  int buildcheck = 0;

  InvoiceManagementServiceView({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    // print(person!.data!.id!);

    final controller = ref.watch(invoiceManagementServiceProvider.notifier);
    final state = ref.watch(invoiceManagementServiceProvider);

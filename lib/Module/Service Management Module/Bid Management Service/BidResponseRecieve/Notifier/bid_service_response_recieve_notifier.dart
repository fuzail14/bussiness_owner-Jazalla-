...
import '../State/bid_service_response_recieve_state.dart';

class BidServiceResponseRecieveNotifier
    extends StateNotifier<BidServiceResponseRecieveState> {
  final Person? person;
  final invoiceManagmentRepository = InvoiceManagmentRepository();

  BidServiceResponseRecieveNotifier({required int invoiceId, this.person})
      : super(BidServiceResponseRecieveState()) {
    invoiceForBuyerView(
...
final bidServiceResponseRecieveProvider = StateNotifierProvider.autoDispose<
    BidServiceResponseRecieveNotifier, BidServiceResponseRecieveState>((ref) {
  ...
  return BidServiceResponseRecieveNotifier(

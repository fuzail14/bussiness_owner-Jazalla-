...
import '../State/award_state.dart';

class AwardNotifier extends StateNotifier<AwardState> {
  final Person? person;
  final eventsRepository = EventsRepository();

  AwardNotifier(this.person) : super(AwardState()) {
...
final awardProvider =
    StateNotifierProvider.autoDispose<AwardNotifier, AwardState>((ref) {
  final person = ref.read(personProvider);
  if (person == null) {
    throw Exception('Person data is not available');
  }
  return AwardNotifier(person);

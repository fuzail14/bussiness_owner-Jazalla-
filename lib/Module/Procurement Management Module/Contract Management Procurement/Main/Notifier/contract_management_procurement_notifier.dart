...
import '../State/contract_management_procurement_state.dart';

class ContractManagementProcurementNotifier
    extends StateNotifier<ContractManagementProcurementState> {
  final Person? person;
  final invoiceManagmentRepository = InvoiceManagmentRepository();

  ContractManagementProcurementNotifier(this.person)
      : super(ContractManagementProcurementState()) {
    invoiceForBuyerView(
...
final contractManagementProvider = StateNotifierProvider.autoDispose<
    ContractManagementProcurementNotifier,
    ContractManagementProcurementState>((ref) {
  final person = ref.read(personProvider);
  if (person == null) {
    throw Exception('Person data is not available');
  }
  return ContractManagementProcurementNotifier(person);
});

...
import '../Notifier/bid_management_procurement_detail_notifier.dart';

class BidManagementProcurementDetailPage extends ConsumerWidget {
  const BidManagementProcurementDetailPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final controller = ref.watch(bidManagementDetailProvider.notifier);
    final state = ref.watch(bidManagementDetailProvider);
    return Scaffold(
      appBar: MyAppBar(
        title: "Bid Detail",
        bellOnTap: () {

...
import '../State/inventory_management_procurement_state.dart';

class InventoryManagementProcurementNotifier
    extends StateNotifier<InventoryManagementProcurementState> {
  final Person? person;
  final invoiceManagmentRepository = InvoiceManagmentRepository();

  InventoryManagementProcurementNotifier(this.person)
      : super(InventoryManagementProcurementState()) {
    invoiceForBuyerView(
...
final inventoryManagementProvider = StateNotifierProvider.autoDispose<
    InventoryManagementProcurementNotifier,
    InventoryManagementProcurementState>((ref) {
  final person = ref.read(personProvider);
  if (person == null) {
    throw Exception('Person data is not available');
  }
  return InventoryManagementProcurementNotifier(person);
});

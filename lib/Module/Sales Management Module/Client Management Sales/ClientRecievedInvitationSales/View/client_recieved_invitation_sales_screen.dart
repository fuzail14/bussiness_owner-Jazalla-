...
import '../../../Bid Management Sales/Main/View/bid_management_sales_view.dart';
import '../Notifier/client_recieved_invitation_sales_notifier.dart';
import 'package:flutter_svg/flutter_svg.dart';

class ClientRecievedInvitationScreen extends ConsumerWidget {
  int buildcheck = 0;

  ClientRecievedInvitationScreen({super.key});
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final controller = ref.watch(clientRecievedInvitationProvider.notifier);
    final state = ref.watch(clientRecievedInvitationProvider);

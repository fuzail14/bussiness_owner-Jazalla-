...
import '../Notifier/complaints_notifier.dart';

// ignore: must_be_immutable
class ComplaintsView extends ConsumerWidget {
  int buildcheck = 0;
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final controller = ref.watch(complaintsProvider.notifier);

...
import '../Notifier/bid_management_procurement_notifier.dart';

// ignore: must_be_immutable
class BidManagementProcurementView extends ConsumerWidget {
  int buildcheck = 0;

  BidManagementProcurementView({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    // print(person!.data!.id!);

    final controller = ref.watch(bidManagementProvider.notifier);
    final state = ref.watch(bidManagementProvider);

...
import '../State/bid_management_procurement_detail_state.dart';

class BidManagementProcurementDetailNotifier
    extends StateNotifier<BidManagementProcurementDetailState> {
  BidManagementProcurementDetailNotifier({
    required int invoiceId,
  }) : super(BidManagementProcurementDetailState()) {
...
final bidManagementDetailProvider = StateNotifierProvider.autoDispose<
    BidManagementProcurementDetailNotifier,
    BidManagementProcurementDetailState>((ref) {
  final args = ref.watch(routeArgsProvider);
  final invoiceId = args['invoiceId'] as int;

  return BidManagementProcurementDetailNotifier(
    invoiceId: invoiceId,
  );

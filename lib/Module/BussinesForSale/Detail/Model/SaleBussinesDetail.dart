class SaleBussinesDetail {
  ...
  SaleBussinesDetail.fromJson(Map<String, dynamic> json) {
  ...
  Map<String?, dynamic> toJson() {
    ...
    data['business'] = business.map((e) => e.toJson()).toList();
    return data;
  }
}

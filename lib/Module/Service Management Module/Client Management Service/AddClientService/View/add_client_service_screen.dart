...
import '../Notifier/add_client_service_notifier.dart';

class AddClientServiceScreen extends ConsumerWidget {
  const AddClientServiceScreen({super.key});
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final controller = ref.watch(addClientServiceProvider.notifier);
    final state = ref.watch(addClientServiceProvider);

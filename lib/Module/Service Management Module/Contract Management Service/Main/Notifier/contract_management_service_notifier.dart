...
import '../State/contract_management_service_state.dart';

class ContractManagementServiceNotifier
    extends StateNotifier<ContractManagementServiceState> {
  final Person? person;
  final invoiceManagmentRepository = InvoiceManagmentRepository();

  ContractManagementServiceNotifier(this.person)
      : super(ContractManagementServiceState()) {
    invoiceForBuyerView(
...
final contractManagementServiceProvider = StateNotifierProvider.autoDispose<
    ContractManagementServiceNotifier, ContractManagementServiceState>((ref) {
  final person = ref.read(personProvider);
  if (person == null) {
    throw Exception('Person data is not available');
  }
  return ContractManagementServiceNotifier(person);
});

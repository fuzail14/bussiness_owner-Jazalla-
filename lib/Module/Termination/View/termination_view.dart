...
import '../Notifier/termination_notifier.dart';

// ignore: must_be_immutable
class TerminationView extends ConsumerWidget {
  int buildcheck = 0;

  TerminationView({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    // print(person!.data!.id!);

    final controller = ref.watch(terminationProvider.notifier);
    final state = ref.watch(terminationProvider);

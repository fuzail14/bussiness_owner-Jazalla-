...
class ComplaintsNotifier extends StateNotifier<ComplaintsState> {
  ...
  ComplaintsNotifier(this.person) : super(ComplaintsState()) {
...
final complaintsProvider =
    StateNotifierProvider.autoDispose<ComplaintsNotifier, ComplaintsState>(
        (ref) {
  final person = ref.read(personProvider);
  if (person == null) {
    throw Exception('Person data is not available');
  }
  return ComplaintsNotifier(person);

...
import '../Notifier/bid_management_sales_detail_notifier.dart';

class BidManagementSalesDetailPage extends ConsumerWidget {
  const BidManagementSalesDetailPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final controller = ref.watch(bidManagementDetailSalesProvider.notifier);
    final state = ref.watch(bidManagementDetailSalesProvider);
    return Scaffold(
      appBar: MyAppBar(
        title: "Bid Detail",
        bellOnTap: () {

...
import '../Notifier/inventory_management_procurement_notifier.dart';

// ignore: must_be_immutable
class InventoryManagementProcurementView extends ConsumerWidget {
  int buildcheck = 0;

  InventoryManagementProcurementView({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    // print(person!.data!.id!);

    final controller = ref.watch(inventoryManagementProvider.notifier);
    final state = ref.watch(inventoryManagementProvider);

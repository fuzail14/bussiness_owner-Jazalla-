...
import '../../Main/Notifier/client_management_mainpage_notifier.dart';
import '../Notifier/add_client_sales_notifier.dart';

class AddClientSalesScreen extends ConsumerWidget {
  const AddClientSalesScreen({super.key});
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final controller = ref.watch(addClientSalesProvider.notifier);
    final state = ref.watch(addClientSalesProvider);

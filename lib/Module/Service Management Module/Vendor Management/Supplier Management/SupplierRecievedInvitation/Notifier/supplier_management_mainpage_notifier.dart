...
class SupplierRecievedInvitationState {
  ...
  SupplierRecievedInvitationState(
  ...
  SupplierRecievedInvitationState copyWith(
      ...
      int? selectedProviderId,
      int? selectedIndex}) {
    return SupplierRecievedInvitationState(
...
class SupplierRecievedInvitationNotifier
    extends StateNotifier<SupplierRecievedInvitationState> {
  final request4InformationRepository = Request4InformationRepository();

  SupplierRecievedInvitationNotifier(Person person)
      : super(SupplierRecievedInvitationState(person: person)) {
...
final supplierRecievedInvitationProvider = StateNotifierProvider.autoDispose<
    SupplierRecievedInvitationNotifier, SupplierRecievedInvitationState>((ref) {
  final person = ref.watch(personProvider);
  if (person == null) {
    throw Exception('Person data is not available');
  }
  return SupplierRecievedInvitationNotifier(person);

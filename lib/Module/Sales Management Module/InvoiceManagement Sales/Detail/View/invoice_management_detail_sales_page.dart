...
import '../Notifier/invoice_management_detail_sales_notifier.dart';
import 'package:pdf/widgets.dart' as pw;
import 'package:path_provider/path_provider.dart';
import 'package:printing/printing.dart';

class InvoiceManagementDetailSalesPage extends ConsumerWidget {
  const InvoiceManagementDetailSalesPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final controller = ref.watch(invoiceManagementDetailSalesProvider.notifier);
    final state = ref.watch(invoiceManagementDetailSalesProvider);
    return Scaffold(
      appBar: MyAppBar(

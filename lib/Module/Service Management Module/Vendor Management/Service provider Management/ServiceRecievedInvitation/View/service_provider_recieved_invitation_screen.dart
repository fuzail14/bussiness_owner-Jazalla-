...
import '../../../../Bid Management Service/Main/View/bid_management_service_view.dart';
import '../Notifier/service_provider_management_mainpage_notifier.dart';
import 'package:flutter_svg/flutter_svg.dart';

class ServiceProviderRecievedInvitationScreen extends ConsumerWidget {
  int buildcheck = 0;

  ServiceProviderRecievedInvitationScreen({super.key});
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final controller =
        ref.watch(serviceProviderRecievedInvitationProvider.notifier);
    final state = ref.watch(serviceProviderRecievedInvitationProvider);

...
import '../State/bid_sales_response_recieve_state.dart';

class BidSalesResponseRecieveNotifier
    extends StateNotifier<BidSalesResponseRecieveState> {
  final Person? person;
  final invoiceManagmentRepository = InvoiceManagmentRepository();

  BidSalesResponseRecieveNotifier({required int invoiceId, this.person})
      : super(BidSalesResponseRecieveState()) {
    invoiceForBuyerView(
...
final bidSalesResponseRecieveProvider = StateNotifierProvider.autoDispose<
    BidSalesResponseRecieveNotifier, BidSalesResponseRecieveState>((ref) {
  ...
  return BidSalesResponseRecieveNotifier(invoiceId: invoiceId, person: person);

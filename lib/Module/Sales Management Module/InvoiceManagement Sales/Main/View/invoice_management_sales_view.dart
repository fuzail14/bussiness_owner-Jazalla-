...
import '../Notifier/invoice_management_sales_notifier.dart';

// ignore: must_be_immutable
class InvoiceManagementSalesView extends ConsumerWidget {
  int buildcheck = 0;

  InvoiceManagementSalesView({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    // print(person!.data!.id!);

    final controller = ref.watch(invoiceManagementSalesProvider.notifier);
    final state = ref.watch(invoiceManagementSalesProvider);

...
import '../Notifier/bid_management_sales_notifier.dart';

// ignore: must_be_immutable
class BidManagementSalesView extends ConsumerWidget {
  int buildcheck = 0;

  BidManagementSalesView({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    // print(person!.data!.id!);

    final controller = ref.watch(bidManagementSalesProvider.notifier);
    final state = ref.watch(bidManagementSalesProvider);

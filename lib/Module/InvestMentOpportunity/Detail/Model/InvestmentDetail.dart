class InvestmentDetail {
  ...
  late final List<Investment> investment;

  InvestmentDetail.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    investment = List.from(json['investment'])
  ...
  Map<String, dynamic> toJson() {
    ...
    _data['investment'] = investment.map((e) => e.toJson()).toList();
    return _data;
  }
}

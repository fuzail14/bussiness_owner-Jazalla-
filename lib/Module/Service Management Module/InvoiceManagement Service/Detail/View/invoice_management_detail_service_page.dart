...
import '../Notifier/invoice_management_detail_service_notifier.dart';
import 'package:pdf/widgets.dart' as pw;
import 'package:path_provider/path_provider.dart';
import 'package:printing/printing.dart';

class InvoiceManagementDetailServicePage extends ConsumerWidget {
  const InvoiceManagementDetailServicePage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final controller =
        ref.watch(invoiceManagementDetailServiceProvider.notifier);
    final state = ref.watch(invoiceManagementDetailServiceProvider);
    return Scaffold(
      appBar: MyAppBar(

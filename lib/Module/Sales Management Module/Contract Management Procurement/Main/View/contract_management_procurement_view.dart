...
import '../Notifier/contract_management_procurement_notifier.dart';

// ignore: must_be_immutable
class ContractManagementProcurementView extends ConsumerWidget {
  int buildcheck = 0;

  ContractManagementProcurementView({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    // print(person!.data!.id!);

    final controller = ref.watch(contractManagementProvider.notifier);
    final state = ref.watch(contractManagementProvider);
